...
{\large\bf\noindent Prefacio}
\bigbreak
Este documento consta de apuntes escritos para la edición 2025 del curso \lq\lq Computación\rq\rq{} de la Facultad de Ciencias de la Universidad de la República. Dentro de los dos cursos de computación dictados por el Centro de matemática, se trata del básico.

En el capítulo 1 se introducen conceptos de computación, incluyendo modelación matemática, hardware, software, lenguajes de programación y compiladores. Para entender el resto del documento, alcanza con la idea \lq\lq por arriba\rq\rq.
