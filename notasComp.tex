...
En esta sección veremos funcionalidades del modo matemático y el modo display. Los capítulos \lq\lq Typing Math Formulas\rq\rq, \lq\lq More about Math\rq\rq, \lq\lq Fine Points of Mathematical Typing\rq\rq{} y \lq\lq Displayed Equations\rq\rq{} del Texbook tienen lo que se presenta aquí con explicaciones menos escuetas, varios ejemplos y ejercicios (cuyas soluciones están en un apéndice), por lo que puede ser muy útil. El único detalle a tener en cuenta es que algunas cosas, como las matrices y las ecuaciones alineadas, se escriben distinto en latex con el paquete {\sl amsmath}, pero la idea de cómo funcionan es análoga. En esta sección usaremos las notaciones que funcionan en latex con el paquete amsmath (pero las explicaciones no serán tan completas como las del Texbook).
...
\subsubsection{raíces, barras, fracciones y corchetes con comentarios}
...
No veremos la creación de tablas. Para esto lo usual es el entorno {\tt tabular} de latex, el cual se presenta en {\sl The Not So Short Introduction to Latex}.
