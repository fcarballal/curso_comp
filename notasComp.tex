...
Se pueden poner cajas en el modo matemático y el modo display. Al hacer eso, dentro de la caja se pasa a modo vertical si es vertical y a modo horizontal si es vertical. En cualquiera de los dos casos, se escribe texto de modo usual. Esto es una forma sencilla de poner texto dentro de una fórmula matemática. Por otra parte, dentro del modo display puede servir para poner texto centrado en medio de la página, como se hizo en el ejemplo de arriba y en el siguiente.
...
Un ejemplo de pegamento vertical que puede ser útil para organizar texto son los \verb|\smallbreak|, \verb|\medbreak| y \verb|\bigbreak|, los cuales agregan espacio vertical el cual es un poco flexible. Como sugieren las palabras, son de tres tamaños distintos. Entre este párrafo y el siguiente hay un \verb|\smallbreak|.
\smallbreak

Un ejemplo conceptualmente interesante y además útil es el de pegamento infinito. Se trata de pegamento con extensibilidad infinita.
