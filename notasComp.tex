...
\begin{figure}
	...
	\includegraphics[width=.4\hsize]{ArqVN.png}
	\includegraphics[width=.4\hsize]{ArqVN.png}
	\caption{Una figura con dos imágenes. Si fueran distintas, capaz convendría fijar la altura en los parámetros opcionales con {\tt height=x}. El salto de línea entre una imagen y la otra se interpreta como un espacio, por lo que están un poco separadas.}
	\label{fig-dosimg}
\end{figure}
