...
Este documento consta de apuntes escritos para la edición 2025 del curso \lq\lq Introducción a la computación\rq\rq{} de la Facultad de Ciencias de la Universidad de la República.

En el capítulo 1 se introducen conceptos de computación, incluyendo modelación matemática, hardware, software, lenguajes de programación y compiladores. El objetivo es introducir algunos conceptos básicos y de motivación para el curso. No hace falta entender profundamente para continuar con el resto.
...
Las estructuras de control de cambio de fuente tienen versiones con parámetros que son las más usadas en latex. Por ejemplo, se puede poner una palabra en negrita con \verb|\textbf{palabra}|. En el capítulo <<fundiciones y tamaños>> de La introducción no-tan-corta a latex \cite{manual2014} se presentan varias fuentes y tamaños.
