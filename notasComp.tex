...
\chapter{Fundamentos e introducción de LaTeX}
...
Respecto a las tablas, en este documento no aparece ninguna y tampoco entraremos en detalle. Ver la sección 2.11.6 \lq\lq Tablas\rq\rq{} de la introducción no-tan-corta a latex, en la que se habla del entorno {\tt tabular}.

\medbreak
Vemos ahora cómo hacer una bibliografía, con la que manejar referencias a otros documentos. Un enfoque bastante usual es el de utilizar bibtex. Se tiene un archivo aparte con terminación {\tt .bib} en el que se guardan las distintas entradas de la bibliografía. Por ejemplo, para el texbook podríamos tener una entrada
\begin{verbatim}
@book{texbook,
...
\end{verbatim}
donde el {\tt texbook} de la primera líenea es el identificador para usar dentro del documento y el resto son datos. Para poner la referencia en el documento había que poner \verb|\cite{texbook}|. El comando \verb|\cite| es el análogo de \verb|\ref| para referencias bibliográficas.

Por último, en el punto en que queremos colocar la bibliografía (normalmente, al final del documento), debemos indicar el estilo y el nombre del archivo {\tt .bib}. Si queremos usar el estilo básico y nuestro archivo de referencias bibliográficas se llama {\tt biblio.bib}, ponemos al final del documento (antes del \verb|\end{document}|) lo siguiente.
\begin{verbatim}
\bibliographystyle{plain}
\bibliography{biblio}
\end{verbatim}
Teniendo en la misma carpeta que el {\tt .tex} al archivo {\tt biblio.bib} en el que ingresamos la entrada para el texbook, ponemos las dos líneas antes del \verb|\end{document}| y podemos referenciar al texbook \cite{texbook}.

En general, para libros o artículos académicos se puede conseguir en internet la entrada en formato de bibtex para poner en el archivo {\tt .bib}.
%\section{Cosas que no tratamos}
%consejos sobre como aprender, entre manuales y buscar en internet
